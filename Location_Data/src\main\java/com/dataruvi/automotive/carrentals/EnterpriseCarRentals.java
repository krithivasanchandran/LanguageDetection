...
public class EnterpriseCarRentals {
	...
	public static void main(String args[]) throws EncryptedDocumentException, InvalidFormatException, IOException,
		...
		/*
		 * Redis Queue - External to maintain the state of the crawl
		 */
	    ...
	    while((str = jedis.lpop("enterpriserental")) != null){
			...
			if (yd != null) {
				...
				/*
				 * Fetching Store Location Hours using the API . Before that - Location ID shall be retreived from the script tags and then hit the api with it
				 * 
				 * eg: https://prd.location.enterprise.com/enterprise-sls/search/location/dotcom/hours/1008013?&from=2018-04-22&to=2018-04-29&locale=en_US
				 * 
				 */
