 ...
 * 
 * 2 Urls Failed - 
 ::: <><> Url's in the queue with exeptions  <><><> :::https://www.alamo.com/en_US/car-rental/locations/us/brdt71-brainerd-airport.html
 ::: <><> Url's in the queue with exeptions  <><><> :::https://www.alamo.com/en_US/car-rental/locations/us/hout71-houston-hobby-airport.html
 
 Make sure to recrawl them again 
 */
...
public class AlamoCarRentals {
	...
	public static void main(String args[]) throws EncryptedDocumentException, InvalidFormatException, IOException,
		...
		try {
			SheetLocalWriter.writeXLSXFile("AlamoRentalsUSA.xlsx", alamoRentalsKeyDataSet);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	}
