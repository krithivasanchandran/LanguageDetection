...
/*
 * When doing large crawls make sure to store the seed urls in a extrernal redis queue or a file
 * 
 * API Locations : https://www.avis.com/webapi/v1/locations/suggestions/AR/en_US
 * 
 * 
 * Failed Ones here :
 ::: <><> Url's in the queue with exeptions  <><><> :::https://www.avis.com/en/locations/us/co/littleton
 ::: <><> Url's in the queue with exeptions  <><><> :::https://www.avis.com/en/locations/oh/us/jm-smuckers-employees-only/avjm1
 ::: <><> Url's in the queue with exeptions  <><><> :::https://www.avis.com/en/locations/ca/us/san-jose/g8n
 ::: <><> Url's in the queue with exeptions  <><><> :::https://www.avis.com/en/locations/hi/us/honolulu-oahu/hi6
 ::: <><> Url's in the queue with exeptions  <><><> :::https://www.avis.com/en/locations/mn/us/saint-paul/hu9
 */
...
public class AvisCarRental {
	...
	public static void main(String args[]) throws EncryptedDocumentException, InvalidFormatException, IOException,
		...
		String parentUrl = "https://www.avis.com/en/locations/us";
		String root = "https://www.avis.com";
	    ...
	    if(jedis.ping().equalsIgnoreCase("PONG")){
	    	...
	    	for(String writeexternal : indivseeds){
			      ...
			      jedis.rpush("avisrental", writeexternal);
			}
	    }
	    subPageSeeds.clear();
	    indivseeds.clear();
