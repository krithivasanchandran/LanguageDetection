...
public class GeoCodingApi {
	...
	public GeoCodingApi(String address,Set<GeoCodeEntityCarrierToExcelWriter> masterData) throws UnsupportedEncodingException{
	...
	private void extractJsonEntities(String jsonResponse,Set<GeoCodeEntityCarrierToExcelWriter> masterData) throws JsonParseException, JsonMappingException, IOException{
