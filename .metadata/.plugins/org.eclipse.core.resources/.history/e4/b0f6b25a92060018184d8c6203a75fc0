...
public class PlacesAPI {
	...
	public PlacesAPI(GeoCodeEntityCarrierToExcelWriter masterPojo,LinkedHashSet<GeoCodeEntityCarrierToExcelWriter> masterData) throws UnsupportedEncodingException{
			...
			fireplacesApi(masterPojo,masterData);
	}
	
	private void fireplacesApi(GeoCodeEntityCarrierToExcelWriter masterPojo,LinkedHashSet<GeoCodeEntityCarrierToExcelWriter> masterData){
		...
		try{
			...
			BufferedReader br = new BufferedReader(new InputStreamReader(
				...
				extractJsonEntities(geoApiResponse,masterPojo,masterData);
